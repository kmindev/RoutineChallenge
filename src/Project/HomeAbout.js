      ...
      <div className='con01'><a href="/challenge">
        <ul>
          <li className='c01-left'>
            ...
            <p>어떤 챌린지든 자유롭게 생성할 수 있습니다.<br/>
              친구/가족/회원들과 챌리지를 공유하며 함께 할 수 있습니다.</p>
            <p>
              <input type='checkbox' id='cb1' />
              <label for='cb1' onClick={linkToChallenge}>챌린지 보러 가기</label>
            </p>
          </li>
      ...
      <div className='con03'><a href="/myPage">
        <ul>
          ...
          <li className='c03-right'>
            ...
            <p>당신의 챌린지와 함께 하세요.<br/>
              참여중인 챌린지를 확인할 수 있습니다.</p>
            <p>
              <input type='checkbox' id='cb2' />
              <label for='cb2' onClick={linkToMypage}>마이페이지 바로가기</label>
            </p>
          </li>
        </ul>
        </a></div>
