...
public interface MemberMapper {
	...
	@Update("update member set member_name=#{member_name}, member_id=#{member_id}, member_password=#{member_password}, "
	...
	@Select("select member_email, member_nickname, member_profile from member where member_id=#{member_id}")
